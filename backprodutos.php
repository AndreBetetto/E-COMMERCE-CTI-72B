    ...
    $array;
		...
		$contProd = "SELECT COUNT(*) as total FROM produtosandre";
                ...
                for($i = 1001; $i <= $rowProd[0]+1000; $i++):
                    ...
                    $array[$i][0] = $mostraTituloProd;
                    $array[$i][1] = $mostraMaterialProd;
                    $array[$i][2] = $mostraPrecoProd;
                    $array[$i][3] = $mostraEstoqueProd;
                    $array[$i][4] = $mostraPromocaoProd;
                    $array[$i][5] = $mostraPromoporcentagemProd;
